...
<div class=" bg-blue-100 p-8 rounded-xl shadow-md w-full max-w-xl">
  <h2 class="text-2xl font-bold text-blue-900 mb-6 text-center">Update Leave Request</h2>

  <form action="leaveUpdateServlet" method="post" class="space-y-4">
    
    <div>
      <label class="block font-medium text-blue-800">ID:</label>
      <input type="text" name="id" value="<%=id%>" readonly
             class="w-full mt-1 p-2 border border-blue-300 rounded bg-gray-100 cursor-not-allowed" />
    </div>

    <div>
      <label class="block font-medium text-blue-800">Name:</label>
      <input type="text" name="name" value="<%=name%>" required
             class="w-full mt-1 p-2 border border-blue-300 rounded" />
    </div>
